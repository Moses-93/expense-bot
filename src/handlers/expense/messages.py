ERROR_MESSAGES = {
    ...
    "invalid_name": "❌ Некоректна назва статті. Спробуйте вказати довшу назву.",
...
ADD_EXPENSE_MESSAGES = {
    ...
    "success_create": "✅ Супер! Витрату додано. Можеш перевірити, чи не забув(ла) щось? 😊",
    "invalid_name": ERROR_MESSAGES["invalid_name"],
    "invalid_date": ERROR_MESSAGES["invalid_date"],
